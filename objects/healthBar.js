export class HealthBar{
    ...
    showHealthBar(){
        ...
        this.entity.ctx.fillRect(this.entity.x + this.gap - 3, this.entity.y - 2, lifePercentage, 5);
        this.entity.ctx.strokeRect(this.entity.x + this.gap - 3, this.entity.y - 2, this.barSize, 5);
    }
